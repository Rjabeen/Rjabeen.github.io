...
/* Adding javascript to loop and making slides absolut */
for(var i =0; i<slides.length;i++) {
    slides[i].style.position = 'absolute';
}

/*
This functions slides from next to previous */
function nextSlide() {
...
/*Inserting play button feature */
var playing = true;
var pauseButton = document.getElementBy('pause');
...
/*Function for play and pause */
 ...
 /* Add listener to the button when clicked */
 ...
 /* checking if javasript is available by setting javascript buttons */
